...
def balanced(m):
    ...
    left_arm = left(m)
    right_arm = right(m)
    b = length(left_arm) * total_weight(end(left_arm)) == length(right_arm) * total_weight(end(right_arm))

    return b and balanced(end(left_arm)) and balanced(end(right_arm))
